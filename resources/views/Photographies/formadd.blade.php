...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('Photographies') }}">
                @csrf
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="txtaddress" id="txtaddress" cols="50" rows="5"></textarea>
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="txtphone" id="txtphone" class="form-control form-control-sm @error('txtfullname') is-invalid @enderror">
                        @error('txtfullname')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
